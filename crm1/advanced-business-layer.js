...
(function(){
  ...
  var modules=[
    ...
    './crm1-role-visibility-final.js?v=1','./crm1-partner-role-ui-final-guard.js?v=1','./crm1-partner-order-table-final-fallback.js?v=1','./crm1-partner-orders-final.js?v=1'
  ];
  lock();

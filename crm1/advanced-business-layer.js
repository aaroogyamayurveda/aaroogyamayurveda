...
(function(){
  ...
  lock();
  (async()=>{
    const load=src=>new Promise(resolve=>{const s=document.createElement('script');s.src=src;s.async=false;s.onload=()=>resolve(true);s.onerror=()=>{console.error('CRM1 module failed to load:',src);resolve(false)};document.head.appendChild(s)});
    try{

...
(function(){
  ...
  var LABEL_TO_PAGE={
    ...
    'advanced reports':'advancedReports','settlements':'settlements','inventory':'inventory',
  ...
  function start(){
    ...
    observer.observe(main,{subtree:true,childList:true,attributes:true,attributeFilter:['class','data-crm1-ready']});
    scan();window.crm1RenderStabilityReady=true;
  }

...
ok('role/navigation modules use a fresh cache-bust version',/admin-ui\.js\?v=crm2-[0-9-]+/.test(index)&&/management-ui\.js\?v=crm2-[0-9-]+/.test(index)&&/app\.js\?v=crm2-[0-9-]+/.test(index));

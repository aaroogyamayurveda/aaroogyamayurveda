...
const index=read('index.html'),app=read('app.js'),data=read('data.js'),workflow=read('modules/workflows.js'),finance=read('modules/finance.js'),ops=read('modules/operations-ui.js'),admin=read('modules/admin-ui.js'),management=read('modules/management-ui.js'),imports=read('modules/import-ui.js'),dealer=read('modules/dealer-ui.js'),targets=read('modules/targets-ui.js'),config=read('config.js'),navRole=read('modules/nav-role-ui.js');
...
ok('index loads independent role navigation module',/src="\.\/modules\/nav-role-ui\.js\?v=crm2-[0-9-]+/.test(index));
ok('role/navigation modules use a cache-bust version',/admin-ui\.js\?v=\d+/.test(index)&&/management-ui\.js\?v=\d+/.test(index)&&/app\.js\?v=\d+/.test(index));

...
ok('create order form is reorganized into CRM1 sections',parity.includes("className='panel crm1-parity-section'")&&parity.includes('Customer Details')&&parity.includes('Order Details'));

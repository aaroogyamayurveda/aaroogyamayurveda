...
const bridgePath=path.join(dir,'modules','create-order-bridge.js');
...
ok('Fast Order bridge is removed',!fs.existsSync(bridgePath)&&!index.includes('create-order-bridge.js'));

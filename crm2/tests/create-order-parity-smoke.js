...
ok('create order form is reorganized into CRM1 sections',parity.includes('Customer Details')&&parity.includes('Complete Delivery Address')&&parity.includes('Order Details'));

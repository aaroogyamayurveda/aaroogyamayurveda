...
window.addEventListener('crm2CreateOrderParityReady',forceRender);window.addEventListener('beforeunload',persistActive);const observer=new MutationObserver(wire);if(document.body)observer.observe(document.body,{subtree:true,childList:true});wire();
